...
import chatboticon from "../../assets/services/chatboticon.svg";
    ...
    return (
        <div className=" flex flex-col items-center justify-center px-6 md:px-12 py-12 ">
            ...
            <HoverCard
                ...
                icon={chatboticon}
                defaultText="Leverage AI chatbots to handle customer inquiries, troubleshoot issues, and guide users efficiently."
