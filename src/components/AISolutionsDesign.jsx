...
//             <h2 className="gradient-text text-[54px] md:text-[56px] font-bold leading-[64.8px] text-center font-space-grotesk">
//                 AI Solutions Designed for
//             </h2>
//             <h2 className="gradient-text text-[54px] md:text-[56px] font-bold leading-[64.8px] text-center font-space-grotesk mb-5">
//                 Your Industry
...
//                         <div
//                             className="relative p-6 rounded-xl shadow-lg border-2 overflow-hidden bg-white text-black  transform transition-all duration-500 w-[700px]"
//                         >
//                             <Image
//                                 src={slide.image}
//                                 alt={slide.title}
//                                 className="w-[663px] h-[371px]"
//                             />
//                             <div className="relative z-10 mt-5">
//                                 <h3 className="text-3xl font-semibold text-[#5a47f5] mb-3" style={{
//                                     color: 'var(--Text-Secondary, rgba(107, 75, 235, 1))'
//                                 }}>{slide.title}</h3>
